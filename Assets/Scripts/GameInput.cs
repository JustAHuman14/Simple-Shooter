...
namespace Assets.Scripts
{
    public class GameInput : MonoBehaviour
    {
        ...
        public event Action<InputAction.CallbackContext> OnWeaponPick;
        ...
        private void Start()
        {
            ...
            _playerInput.Player.SpawnEnemy.performed += PlayerInput_OnSpawnEnemy;
        ...
        private void PlayerInput_OnSpawnEnemy(InputAction.CallbackContext context) => OnSpawnEnemy?.Invoke(context);
